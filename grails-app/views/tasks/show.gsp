...
<%@ page import="tasks.grails.master.Tasks" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-tasks" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:tasksInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${tasksInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
